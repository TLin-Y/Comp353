		...
		if($_GET[type]=="add")    	
			{
	    		...
	    		if($aff)
	    		{
	    			...
	    			echo "<div align=\"center\" class=\"title\">Add reader sucess！<br><br><a href='reader.php?page=1'>View reader</a></div>";
	    		}
	    		else 
	    		{
	    			echo "<div align=\"center\" class=\"title\">Add reader fail！Re-add click<a href='readeradd.php'><img src=\"img/return1.gif\" border=\"0\"/></a></div>";
	    		}
			}
