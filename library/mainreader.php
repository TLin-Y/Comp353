...
<body>
<script src="http://open.sojson.com/common/js/canvas-nest.min.js" count="50" zindex="-2" opacity="0.5" color="47,135,193" type="text/javascript">
    </script>
	...
	<script>
		...
		function t(){
		 ...
		 if(va=="1"){
			document.getElementById('form1').action="mainreader.php?";
		 }
		 else if(va=="2"){
		 	document.getElementById('form1').action="mainreader.php?";
		 }
...
<p align="center" style=" margin-right:500px">Welcome, Reader!</p>
<p align="center" style=" margin-right:100px">This is the 353-Library, you can add order and view book information here.
...
<br>
	...
	<table width="80%"  border="1" cellspacing="0" cellpadding="0" align="right" class="title" >
		...
		?>
		<tr>
			<th colspan="8" align="center"><a href="bookreader.php?page=1">Click HERE to find more</a></th>
		</tr>
	</table>