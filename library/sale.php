...
<body>
	...
	<table width="90%"  bsale="1" cellspacing="0" cellpadding="0" align="center" class="title">
	  <tr>
	    <th colspan="9"><p align="center" class="STYLE1">Sale history&nbsp;&nbsp;</p></th>
	  </tr>
	  <tr>
	    ...
	    <th width="10%"><div align="center">Employee</div></th>
	    <th width="10%"><div align="center">Customer</div></th>
	    ...
	    <th width="5%"><div align="center">Operate</div></th>
	  </tr>
	  <?php
	  		$offset=($_GET[page]-1)*$pageNum;
	  		$sql="SELECT * FROM sale LIMIT {$offset} , {$pageNum} ";
				...
				echo "<tr>
						...
						<td>
							<div align=\"center\"> 
								...
								<a href=\"saleadd.php?snumber={$row[7]}&type=del\">Delete</a>&nbsp;&nbsp;&nbsp;
	...
	<?php
		...
		if($_GET[page]>1){
			echo "<a href='sale.php?page=1'>Top</a>&nbsp;";
			echo "<a href='sale.php?page=".($_GET[page]-1)."'>Prev</a>&nbsp;";
		}
		if ($_GET[page]<$total) {
			echo "<a href='sale.php?page=".($_GET[page]+1)."'>Next</a>&nbsp;";
			echo "<a href='sale.php?page=$total'>End</a>&nbsp;";
		}
		?>
	<?php
		for($i=1;$i<=$total;$i++)
